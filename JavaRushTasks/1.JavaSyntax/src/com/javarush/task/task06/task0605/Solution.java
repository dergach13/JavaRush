...
public class Solution {
    ...
    public static class Body {
        public static void massIndex(double weight, double height) {
            ...
            int level = 1;
            String conclusion = "Недовес: меньше чем 18.5";

            level += (index >= 18.5) ? 1 : 0;
            level += (index >= 25) ? 1 : 0;
            level += (index >= 30) ? 1 : 0;

            switch (level){
                case 2:
                    conclusion = "Нормальный: между 18.5 и 24.9";
                    break;
                case 3:
                    conclusion = "Избыточный вес: между 25 и 29.9";
                    break;
                case 4:
                    conclusion = "Ожирение: 30 или больше";
                    break;
            }
